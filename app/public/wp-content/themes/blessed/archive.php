...
<?php // 現在使用しているテンプレートファイルを表示
  if (is_user_logged_in()){ // ログイン中なら以下を表示
    ...
    $temp_name = basename($template); // パスの最後の名前（ファイル名）取得
    ...
    <div class="single_wrapper">
        <div class="single_wrapper-left">
            <section class="listpage">
                <?php
                    $publish_month = wp_get_archives();
                ?>
                <h1 class="listpage_title"><span>Blog Category</span><?php echo $cat_name; ?></h1>
...
<section class="form" id="form" name="form">
    <div class="form_wrapper">
        ...
        <?php echo do_shortcode('[contact-form-7 id="109" title="体験申し込み & お問い合わせ"]'); ?>
    </div>
</section>
<!-- float banner -->
