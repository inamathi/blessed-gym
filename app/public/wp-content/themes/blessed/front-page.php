...
<section class="hero">
    <div class="hero_wrapper">
        ...
        <dl class="hero_wrapper-lead">
            <!-- <dt>想像を越えた、理想の身体を</dt> -->
            <dd>
                コンディショニングジム「BLESSED」なら<br />身体の内部からコンディショニング。<br />スタイリッシュに、機能的に、かつ健康的に。
            </dd>
            <dd class="large">
                あなた自身もまだ知らない<br />理想の身体を実現しませんか？
            </dd>
        </dl>
    </div>
    <!-- 自動スライドショー -->
...
<section class="worry">
    <div class="worry_wrapper">
        <ul class="worry_list">
            <li>何度も挫折・・・意志が弱い？</li>
            <li>痩せてもすぐ太る。キープしたいのに！</li>
            <li>腰回りのお肉・・・年取ったら仕方ない？</li>
            <li>自分流でやってるけど、全然痩せない！</li>
        </ul>
        <h2>考えるより行動を❗️<br />BLESSEDが解決します</h2>
    </div>
</section>
...
<section class="concept">
    ...
    <div class="concept_wrapper">
        ...
        <div class="before-after-container">
            <div><img src="<?php echo get_template_directory_uri(); ?>/img/img-before-after-01.jpg"></div>
            <div><img src="<?php echo get_template_directory_uri(); ?>/img/img-before-after-02.jpg"></div>
        </div>
...
<section class="price" id="price">
    ...
    <div class="price_wrapper">
        <div class="price_list">
                <h3 class="item-title-rect">体験料金・入会金<span>（料金はすべて税込表記）</span></h3>
            ...
            <div class="price_list-item subscription">
                <h3 class="item-title-rect">月額コース<span>（料金はすべて税込表記）</span></h3>
                <div class="session-desc">パーソナルトレーニング ６０分／１回あたり</div>
                ...
                <div class="item-block-list">
                    <div class="item-block popup">
                        <div class="item-block-after">
                            ...
                            <span class="material-symbols-outlined item-block-after-arrow">arrow_forward</span>
                            <span class="item-block-after-price"><span>¥</span>14,000</span>
                        </div>
                        <div class="item_content-minit">¥7,000／１回あたり</div>
                    </div>
                    <div class="item-block popup">
                        <div class="item-block-after">
                            <span class="item-block-after-times">月４回コース</span>
                            <span class="material-symbols-outlined item-block-after-arrow">arrow_forward</span>
                            <span class="item-block-after-price"><span>¥</span>25,000</span>
                        </div>
                        <div class="item_content-minit">¥6,250／１回あたり</div>
                    </div>
                    <div class="item-block popup">
                        <div class="item-block-after">
                            <span class="item-block-after-times">月８回コース</span>
                            <span class="material-symbols-outlined item-block-after-arrow">arrow_forward</span>
                            <span class="item-block-after-price"><span>¥</span>42,000</span>
                        </div>
                        <div class="item_content-minit">¥5,250／１回あたり</div>
                    </div>
                    <!-- <div class="item-block popup">
            ...
            <div class="price_list-item long">
                <h3 class="item-title-rect">回数券コース<span>（料金はすべて税込表記）</span></h3>
                <div class="session-desc">パーソナルトレーニング ６０分／１回あたり</div>
                <div class="item-block-list">
                    <div class="item-block popup">
                        <div class="item-block-after">
                        ...
                        <div class="item_content-minit">¥8,000／１回あたり</div>
                    </div>
                    <div class="item-block popup">
                        <div class="item-block-after">
                        ...
                        <div class="item_content-minit">¥7,700／１回あたり</div>
                    </div>
                    <div class="item-block popup">
                        <div class="item-block-after popup">
                        ...
                        <div class="item_content-minit">¥7,480／１回あたり</div>
                    </div>
                </div>
            </div>
            <!-- アスリートコース -->
            <div class="price_list-item long">
                <h3 class="item-title-rect">アスリートコース<span>（料金はすべて税込表記）</span></h3>
                <div class="item-block-list">
                    <div></div>
                    <div class="item-block popup">
                        <div class="item-block-after">
                            <span class="item-block-after-times">１回（６０分）</span>
                            <span class="material-symbols-outlined item-block-after-arrow">arrow_forward</span>
                            <span class="item-block-after-price"><span>¥</span>6,600</span>
                        </div>
                        <!-- <div class="item_content-minit">¥6,000／１回あたり</div> -->
                    </div>
                    <div></div>
                </div>
            </div>
