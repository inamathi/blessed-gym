...
<main>
    <div class="single_wrapper">
        <div class="single_wrapper-left">
            <section class="listpage-staff">
                <h1 class="listpage-staff_title">スタッフより</h1>
                <ul class="listpage-staff_itemlist">
                    <?php
                        $args = array(
                            'post_type'=> 'staff',
                            'post_status' => 'publish',
                        ...
                        $staffList = SCF::get('staff_item');
                            ...
                            ?>
                            <li class="listpage-staff_itemlist-item">
                                <div>
                                    <div class="thumbnail">
                                    ...
                                    <div class="profile">
                                        ...
                                        <p class="memo"><?php echo nl2br($staff['staff_memo']); ?></p>
                                    </div>
                                </div>
                                <div>
                                    <p class="comment"><?php echo nl2br($staff['staff_comment']); ?></p>
                                </div>
                            </li>
                    <?php } ?>
                    <?php endforeach; ?>
